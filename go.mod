module github.com/Faze-Technologies/go-utils
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/go.mongodb.org/mongo-driver/v2/mongo/otelmongo v0.0.0-20260206093924-44f1919add0b
