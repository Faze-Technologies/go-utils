...
var InternalServices = map[string]string{
	...
	"fandomEventAdminService":       "http://fandom-event-admin-service.fandom-event-admin-service.svc.cluster.local",
	"fandomEventService":            "http://fandom-event-service.fandom-event-service.svc.cluster.local",
	"fandomEventsStatsAdminService": "http://fandom-events-stats-admin-service.fandom-events-stats-admin-service.svc.cluster.local",
	"fandomUserService":             "http://fandom-user-service.fandom-user-service.svc.cluster.local",
	"fandomPacksAdminService":       "http://fandom-packs-admin-service.fandom-packs-admin-service.svc.cluster.local",
	"fandomPacksService":            "http://fandom-packs-service.fandom-packs-service.svc.cluster.local",
